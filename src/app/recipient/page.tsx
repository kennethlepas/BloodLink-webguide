            ...
            <main className="bg-slate-50 flex-grow py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl font-black text-slate-900 mb-4">Recipient Guide</h1>
                        <p className="text-lg text-slate-600">Essential information for safe blood transfusion and recovery.</p>
                    </div>

                    <div className="space-y-12">
                        {RECIPIENT_GUIDE.map((section) => (
                            <div key={section.id} className="bg-white rounded-[2rem] p-8 md:p-12 shadow-sm border border-slate-100">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                    {section.content.map((item, i) => (
                                        <div key={i}>
                                            <h3 className="text-sm font-black text-blue-600 uppercase tracking-widest mb-6 border-b border-blue-50 pb-2 inline-block">
                                                {item.subtitle}
                                            </h3>
                    ...
                    <div className="mt-20 bg-slate-900 rounded-[2.5rem] p-8 md:p-12 text-white overflow-hidden relative shadow-2xl">
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-balance">
                            <div className="max-w-md text-center md:text-left">
                                <h2 className="text-3xl font-black mb-4">Urgent Blood Request?</h2>
                                <p className="text-slate-400 mb-0 leading-relaxed">
                                    If you need blood urgently for a loved one, our app can connect you with the nearest donors and blood banks in minutes.
                                </p>
                            </div>
                            <button className="px-8 py-4 bg-blue-600 text-white font-black rounded-2xl shadow-xl shadow-blue-500/20 hover:bg-blue-700 transition-colors whitespace-nowrap">
                                Download BloodLink App
                            </button>
                        </div>

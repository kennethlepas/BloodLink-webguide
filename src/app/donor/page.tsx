            ...
            <main className="bg-slate-50 flex-grow py-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-16">
                        <h1 className="text-4xl font-black text-slate-900 mb-4">Donor Guide</h1>
                        <p className="text-lg text-slate-600">Everything you need to know about becoming a life-saver.</p>
                    </div>
                    ...
                    <div className="mt-20 bg-blue-600 rounded-[2.5rem] p-8 md:p-12 text-white overflow-hidden relative shadow-2xl shadow-blue-200">
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div className="max-w-md text-center md:text-left">
                                ...
                                <p className="text-blue-100 mb-0 leading-relaxed">
                                    Join thousands of other Kenyans who are making a difference every day. Find your nearest donation center in the app.
                                </p>
                            </div>
                            <button className="px-8 py-4 bg-white text-blue-600 font-black rounded-2xl shadow-xl hover:bg-slate-50 transition-colors whitespace-nowrap">
